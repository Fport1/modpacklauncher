...
export default function Sidebar() {
  ...
  const extraNavItems = [
    ...
    {
      to: '/ftp',
      labelKey: 'nav_ftp' as const,
      icon: <svg width={ICO} height={ICO} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="2" y="3" width="20" height="7" rx="1.5"/><rect x="2" y="14" width="20" height="7" rx="1.5"/><line x1="6" y1="6.5" x2="6.01" y2="6.5"/><line x1="6" y1="17.5" x2="6.01" y2="17.5"/></svg>,
      show: true
    },
    {
      to: '/status',
